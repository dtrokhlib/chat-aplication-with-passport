...
const insertMesssageBlock = (messages) => {
  messages.forEach(message => {
    ...
    innerDiv.innerHTML = `<span style="text-decoration: underline;">${message.userId.firstName} ${message.userId.lastName}</span>
  <span style="float: right;">${message.date}</span><br /><span>${message.message}</span>`;
